...
public class InTheaterMovieServiceImp implements InTheaterMovieService {
    ...
    public List<Movie> getMovieByTag(String tag) {
        ...
        if (tag.equals("Featured")) {
            ...
            movieList.add(new Movie("Movie 3", "/images/homepage/featureMoviesImages/m3.jpg"));
            movieList.add(new Movie("Movie 4", "/images/homepage/featureMoviesImages/m4.jpg"));

        } else if (tag.equals("Top Rating")) {
            movieList.add(new Movie("Movie 5", "/images/homepage/featureMoviesImages/m5.jpg"));
            movieList.add(new Movie("Movie 6", "/images/homepage/featureMoviesImages/m6.jpg"));

        } else if (tag.equals("Recently Added")) {
            movieList.add(new Movie("Movie 7", "/images/homepage/featureMoviesImages/m7.jpg"));
            movieList.add(new Movie("Movie 8", "/images/homepage/featureMoviesImages/m8.jpg"));
        } else {
            movieList = null;
        }
        return movieList;
