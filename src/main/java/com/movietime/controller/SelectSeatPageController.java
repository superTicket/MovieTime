...
public class SelectSeatPageController {
    ...
    @ResponseBody
    public String post_selectSeat(int theater_id, int show_id, String selectedList_JSON, Model model) {
        System.out.println("POST@'/selectSeat': theater_id=" + theater_id + ", show_id=" + show_id + ", selectedList_JSON=");
    ...
    public String get_selectSeat(@PathVariable("cinema_id") int theater_id,
        ...
        model.addAttribute("show_id", show.id);
